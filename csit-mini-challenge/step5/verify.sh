...
imageName=$(kubectl get pod -n default analysis-pod -o jsonpath='{.spec.containers[?(@.name=="analysis-pod")].image}')
location=$(kubectl exec -n default analysis-pod -- cat /mnt/location/tipoff)
